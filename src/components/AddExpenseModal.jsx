        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex-1 py-3.5 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition-all flex justify-center items-center gap-2 text-sm disabled:opacity-70"
            >
              {submitting ? (
